...
public class AliSdkTransactionActivity extends AppCompatActivity {
    ...
    private String itemId = "555174272059";//默认商品id
    ...
    public void showDetail(View view) {
        ...
        if (isTaoke) {
            alibcTaokeParams = new AlibcTaokeParams("mm_110385786_0_0", "", "");
        } else {
    ...
    public void addToCart(View view) {
        ...
        if (isTaoke) {
            alibcTaokeParams = new AlibcTaokeParams("mm_110385786_0_0", "mm_110385786_0_0", null);
        } else {
            alibcTaokeParams = null;
        }
